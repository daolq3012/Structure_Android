...
public class MainPresenterTest {
    ...
    @InjectMocks
    ImmediateSchedulerProvider mImmediateSchedulerProvider;

    @Before
    public void setUp() throws Exception {
        mMainPresenter.setViewModel(mMainViewModel);
        mMainPresenter.setSchedulerProvider(mImmediateSchedulerProvider);
    }
